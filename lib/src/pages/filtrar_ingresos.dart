...
class FiltrarIngresos extends StatefulWidget {
    static final String routeName = 'FiltrarIngresos';
  @override
  FiltrarIngreClass createState() => FiltrarIngreClass();
}


class FiltrarIngreClass extends State<FiltrarIngresos> {
