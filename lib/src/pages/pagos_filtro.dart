...
class FiltrarPagos extends StatefulWidget {
    static final String routeName = 'FiltrarPagos';
  @override
  FiltrarPagosClass createState() => FiltrarPagosClass();
}


class FiltrarPagosClass extends State<FiltrarPagos> {
  ...
  List<String> _cat = ['Uno', 'Dos', 'Categoria'];
    String _opcionUsu = 'Usuario';
  List<String> _usu = ['Uno', 'Dos', 'Usuario'];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView(
        ...
        children: <Widget>[
          Text('FILTRAR INFORMACIÓN', style: TextStyle(fontSize: 20.0, fontWeight: FontWeight.bold), textAlign: TextAlign.center,),
